...
int main(int argc, char *argv[])
{
    ...
    if(argc > 1)
    {
        ...
        else if (s=="play" || s=="-play" || s=="-p")
        {
            ...
            for (int i = 2; i < argc; ++i)
            {
                ...
                if (param=="max" || param=="-max" || param=="-m")
                {
                    ...
                    if (max < 2)
                    {
                        cout << red << "Error!\t" << reset << "Invalid/undefined max value!"  << endl;
                        return -1;
                    }
                    data.max = max;
                }
                else if(param=="length" || param=="-length" || param=="-l")
                {
                    ...
                    if (length < 1)
                    {
                        cout << red << "Error!\t" << reset << "Invalid/undefined length value!" << endl;
                        return -1;
                    }
                    data.length = length;
                }
                else if(param=="size" || param=="-size" || param=="-s")
                {
                    ...
                    if (size < 1 || size > 3)
                    {
                        cout << red << "Error!\t" << reset << "Invalid/undefined size value!" << endl;
                        return -1;
                    }
                    data.group_size = size;
                }

                else if(param=="single" || param=="-single" || param=="-s")
                {
                    data.group_size = 1;
                }
                ...
                {
                    cout << red << "Error!\t" << reset << "Unknown game argument: " << argv[i] <<endl;
                    return -1;
                }
            }
        ...
        {
            cout << red << "Error!\t" << reset << "Unknown argument: " << argv[1] <<endl;
            return -1;
        }
    }
    else
